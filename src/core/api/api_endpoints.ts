...
export const updateUserDetailsEndpoint = (user?: UserModel | null): string =>
  `/users/${user?._id}`;
export const sendVerificationDocumentDataEndpoint = "/verifications";
export const fetchUserByIdEndpoint = (user?: UserModel | null): string =>
  `/users/${user?._id}`;
export const usernameOnboardingEndpoint = (user?: UserModel | null): string =>
  `/users/onboarding/${user?._id}`;
export const fetchDocumentTypesEndpoint = (
  countryData?: VerifiedCountryModel | null
): string => `/country-verifications/${countryData?._id}`;
...
export const fetchNotificationPreferenceEndpoint = (
  user?: UserModel | null
): string => `/users/settings/${user?._id}`;
export const updateNotificationPreferenceEndpoint = (
  user?: UserModel | null
): string => `/users/settings/${user?._id}`;
...
export const updatePriceAlertEndpoint = (
  priceAlertId?: string | null
): string => `/priceAlerts/${priceAlertId}`;
export const fetchPriceAlertsEndpoint = (user?: UserModel | null): string =>
  `/priceAlerts/user/${user?._id}`;
export const fetchActivityLogEndpoint = (user?: UserModel | null): string =>
  `/activities/${user?._id}`;
export const fetchTransactionsEndpoint = (user?: UserModel | null): string =>
...
// Accounts Endpoints
export const fetchAccountsEndpoint = (user?: UserModel | null): string =>
  `/accounts/user/${user?._id}`;
...
export const tokenDetailsEndpoint = (tokenId?: string | null): string =>
  `/markets/${tokenId}`;
export const tokenHistoryEndpoint = (tokenId?: string | null): string =>
  `/markets/history/${tokenId}`;
export const removeTokenFromWatchlistEndpoint = (
  watchlistToken?: WatchlistTokenModel | null
): string => `/watchlists/${watchlistToken?._id}`;
export const fetchWatchlistTokensEndpoint = (user?: UserModel | null): string =>
  `/watchlists/user/${user?._id}`;
...
export const fetchSupportConversationEndpoint = (
  conversationId?: string | null
): string => `/support/conversations/${conversationId}`;
export const closeSupportConversationEndpoint = (
  conversationId?: string | null
): string => `/support/conversations/${conversationId}`;
export const markSupportConversationAsSpamEndpoint = (
  conversationId?: string | null
): string => `/support/conversations/${conversationId}`;
export const reopenSupportConversationEndpoint = (
  conversationId?: string | null
): string => `/support/conversations/${conversationId}/reOpen`;
export const reassignSupportConversationEndpoint = (
  conversationId?: string | null
): string => `/support/conversations/${conversationId}/reAssign`;
...
export const fetchSupportMessageEndpoint = (
  messageId?: string | null
): string => `/support/messages/${messageId}`;
export const readSupportMessageEndpoint = (messageId?: string | null): string =>
  `/support/messages/${messageId}/read`;
export const deleteSupportMessageEndpoint = (
  messageId?: string | null
): string => `/support/messages/${messageId}`;
