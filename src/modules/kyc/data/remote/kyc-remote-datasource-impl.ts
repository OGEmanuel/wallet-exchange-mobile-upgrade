...
import { authenticateEmailOtpEndpoint, authenticatePhoneNumberOtpEndpoint, getOnboardingOtpEndpoint, requestNewOtpEndpoint, submitVerificationEndpoint, updatePhoneNumberEndpoint, usernameOnboardingEndpoint } from "../../../../core/api/api_endpoints";
...
export class KycRemoteDatasourceImpl implements KycRemoteDatasource {
  ...
  async verifyEmail(payload: GeneralRequestModel<VerifyEmailParams, unknown, unknown>): Promise<GeneralResponseModel<unknown>> {
    const response = await httpClient.post<GeneralResponseModel<unknown>>(authenticateEmailOtpEndpoint, payload);
    return response.data;
  }

  async addUsername(payload: GeneralRequestModel<AddUsernameParams, unknown, UserModel>): Promise<GeneralResponseModel<unknown>> {
    const response = await httpClient.post<GeneralResponseModel<unknown>>(usernameOnboardingEndpoint(payload.extra), payload);
    return response.data;
  }
  ...
  async authPhoneNumber(payload: GeneralRequestModel<AuthPhoneNumberParams, unknown, unknown>): Promise<GeneralResponseModel<unknown>> {
    const response = await httpClient.post<GeneralResponseModel<unknown>>(updatePhoneNumberEndpoint, payload);
    return response.data;
  }
  ...
  async verifyPhoneNumberOtp(payload: GeneralRequestModel<VerifyPhoneNumberOtpParams, unknown, unknown>): Promise<GeneralResponseModel<unknown>> {
    const response = await httpClient.post<GeneralResponseModel<unknown>>(authenticatePhoneNumberOtpEndpoint, payload);
    return response.data;
  }

  async resendPhoneNumberOtp(payload: GeneralRequestModel<ResendAuthPhoneNumberOtpParams, unknown, unknown>): Promise<GeneralResponseModel<unknown>> {
    const response = await httpClient.post<GeneralResponseModel<unknown>>(requestNewOtpEndpoint, payload);
    return response.data;
  }
  ...
  async uploadCreditDocument(payload: GeneralRequestModel<CreditDocumentDataParam, unknown, unknown>): Promise<GeneralResponseModel<unknown>> {
    const response = await httpClient.post<GeneralResponseModel<unknown>>(submitVerificationEndpoint, payload);
    return response.data;
  }
