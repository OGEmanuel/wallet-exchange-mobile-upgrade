          ...
          >
            ...
            <View style={styles.section}>
              ...
              >
                ...
                application. By using our services, you agree to comply with
            ...
            <View style={styles.section}>
              <Text
                style={[styles.text, { color: theme.colors.bodyTextColor }]}
              >
                These Zap Terms of Use ("Terms") govern your use of the services
                provided by Zap in relation to the Digital Currency Exchange
                Platform ("Platform"). By accessing, downloading, using or
                clicking on “I agree” to accept any Zap Services (as defined
                below) provided by Zap (as defined below), you agree that you
                have read, understood and accepted all of the terms and
                conditions stipulated in these Terms as well as our Privacy
                Policy. In addition, when using some features of the Services,
                you may be subject to specific additional terms and conditions
                applicable to those features. Please read the terms carefully as
                they govern your use of Zap Services. These terms contain
                important provisions including an arbitration provision that
                requires all claims to be resolved by way of legally binding
                arbitration. The terms of the arbitration provision are set
                forth in Clause 15, “Dispute Resolution”. As with any asset, the
                values of Digital Currencies may fluctuate significantly and
                there is a substantial risk of economic losses when purchasing,
                selling, holding or investing in Digital Currencies and their
                derivatives. By making use of Zap Services, you acknowledge and
                agree that: (a) you are aware of the risks associated with
                transactions of digital currencies and their derivatives; (b)
                you shall assume all risks related to the use of Zap Services
                and transactions of digital currencies and their derivatives;
                and (c) Zap shall not be liable for any such risks or adverse
                outcomes. By accessing, using or attempting to use Zap Services
                in any capacity, you acknowledge that you accept and agree to be
                bound by these Terms. If you do not agree, do not access Zap or
                utilize Zap Services.
              </Text>
            </View>
...
13.5. All transactions signed and initiated by Users through their wallets are final and irreversible.`}
 ...
 14.2. All users of Zap Services acknowledge and declare that their funds come from legitimate sources and do not originate from illegal activities; users agree that Zap will require them to provide or otherwise collect the necessary information and materials as per relevant laws or government orders to verify the legality of the sources and use of their funds. Zap maintains a stance of cooperation with law enforcement authorities globally and will not hesitate to seize, freeze, terminate Users’ accounts and funds which are flagged out or investigated by legal mandate.`}</Text>
          ...
          >
            <Image
              source={Icons.evaArrowDown}
              style={{ width: 20, height: 20, tintColor: "#FBFBFB" }}
              resizeMode="contain"
            />
          </TouchableOpacity>
        </View>
