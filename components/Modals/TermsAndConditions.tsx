          ...
          >
            ...
            <View style={styles.section}>
              <Text
                style={[styles.text, { color: theme.colors.bodyTextColor }]}
              >
                These Zap Terms of Use (&quot;Terms&quot;) govern your use of
                the services provided by Zap in relation to the Digital Currency
                ...
                that requires all claims to be resolved by way of legally
                binding arbitration. The terms of the arbitration provision are
                set forth in Clause 15, “Dispute Resolution”. As with any asset,
                the values of Digital Currencies may fluctuate significantly and
