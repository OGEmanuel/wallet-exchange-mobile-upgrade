...
const ThemedPdfIcon: React.FC<ThemedPdfIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
<path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" fill="${fillColor}"/>
...
<path d="M8.26702 14.6801C8.08302 14.6801 7.95902 14.6981 7.89502 14.7161V15.8941C7.97102 15.9121 8.06602 15.9171 8.19702 15.9171C8.67602 15.9171 8.97102 15.6751 8.97102 15.2661C8.97102 14.9001 8.71702 14.6801 8.26702 14.6801ZM11.754 14.6921C11.554 14.6921 11.424 14.7101 11.347 14.7281V17.3381C11.424 17.3561 11.548 17.3561 11.66 17.3561C12.477 17.3621 13.009 16.9121 13.009 15.9601C13.015 15.1301 12.53 14.6921 11.754 14.6921Z" fill="#EA1D27"/>
</svg>
`;
