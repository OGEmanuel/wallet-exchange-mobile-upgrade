...
interface ThemedCommandOutlineIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedCommandOutlineIcon: React.FC<ThemedCommandOutlineIconProps> = ({ 
  width = 16, 
  height = 16, 
  style,
...
export default ThemedCommandOutlineIcon;
