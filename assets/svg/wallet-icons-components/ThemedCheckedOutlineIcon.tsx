...
interface ThemedCheckedOutlineIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedCheckedOutlineIcon: React.FC<ThemedCheckedOutlineIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedCheckedOutlineIcon;
