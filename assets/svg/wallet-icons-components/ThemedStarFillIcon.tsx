...
interface ThemedStarFillIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedStarFillIcon: React.FC<ThemedStarFillIconProps> = ({ 
  width = 16, 
  height = 16, 
  style,
...
export default ThemedStarFillIcon;
