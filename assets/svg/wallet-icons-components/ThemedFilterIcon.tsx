...
interface ThemedFilterIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedFilterIcon: React.FC<ThemedFilterIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedFilterIcon;
