...
interface ThemedSignOutIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedSignOutIcon: React.FC<ThemedSignOutIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedSignOutIcon;
