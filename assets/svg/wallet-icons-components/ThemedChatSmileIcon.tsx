...
interface ThemedChatSmileIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedChatSmileIcon: React.FC<ThemedChatSmileIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedChatSmileIcon;
