...
interface ThemedUploadIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedUploadIcon: React.FC<ThemedUploadIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedUploadIcon;
