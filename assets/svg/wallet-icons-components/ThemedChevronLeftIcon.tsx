...
interface ThemedChevronLeftIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedChevronLeftIcon: React.FC<ThemedChevronLeftIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
<path d="M15 18L9 12L15 6" stroke="${strokeColor}" stroke- stroke-linecap="round" stroke-linejoin="round"/>
</svg>
`;
...
export default ThemedChevronLeftIcon;
