...
interface ThemedWalletOutlineIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedWalletOutlineIcon: React.FC<ThemedWalletOutlineIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedWalletOutlineIcon;
