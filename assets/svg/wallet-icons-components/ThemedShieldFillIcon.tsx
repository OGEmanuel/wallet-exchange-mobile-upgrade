...
interface ThemedShieldFillIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedShieldFillIcon: React.FC<ThemedShieldFillIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
<path d="M12 1L3 5V11C3 16.55 6.84 21.74 12 23C17.16 21.74 21 16.55 21 11V5L12 1Z" fill="${fillColor}"/>
</svg>
`;
...
export default ThemedShieldFillIcon;
