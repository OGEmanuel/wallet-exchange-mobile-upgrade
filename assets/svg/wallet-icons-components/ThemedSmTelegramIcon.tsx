...
interface ThemedSmTelegramIconProps {
  width?: number;
  height?: number;
  style?: any;
...
const ThemedSmTelegramIcon: React.FC<ThemedSmTelegramIconProps> = ({ 
  width = 24, 
  height = 24, 
  style,
...
export default ThemedSmTelegramIcon;
