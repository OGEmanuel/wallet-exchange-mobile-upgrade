...
export const usePortfolio = () => {
  ...
  const handleRefresh = async () => {
    try {
      ...
      setError('Failed to refresh portfolio. Please check your connection and try again.');
    }
  };
  ...
  return {
    ...
    hasAssets: processedPortfolio ? processedPortfolio.enabledAssets.length > 0 : false,
